...
from pyrogram.types import *
from logging import getLogger
from SomuX.utils.database import get_assistant
from time import time
import asyncio
from SomuX.utils.extraction import extract_user
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("SomuX/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((825, 824))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('SomuX/assets/font.ttf', size=110)
    welcome_font = ImageFont.truetype('SomuX/assets/font.ttf', size=60)
